    ...
    <footer ref={ref} className="relative py-28 px-6">
      ...
      <div className="relative container max-w-5xl mx-auto border-t border-border/50 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-6">
          <a href="https://github.com/zerwonenetwork/aibridge-core" target="_blank" rel="noopener noreferrer" className="text-xs text-muted-foreground/50 hover:text-primary transition-colors font-display">GitHub</a>
        </div>
